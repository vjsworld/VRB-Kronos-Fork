...
from .tabs_theta import ThetaHarvestTab
...
class MainWindow(QMainWindow):
    def __init__(self, root: str = "SPXW"):
        ...
        self.theta_tab = ThetaHarvestTab(self.state)
        ...
        self.tabs.addTab(self.theta_tab, "Theta Harvesting")
    ...
    def closeEvent(self, event) -> None:
        ...
        for tab in (self.backtest_tab, self.gamma_tab, self.theta_tab,
                    self.report_tab, self.forecast_tab, self.mllab_tab):
